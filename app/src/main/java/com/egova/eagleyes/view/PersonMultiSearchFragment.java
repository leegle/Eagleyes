...
import com.egova.eagleyes.adapter.PersonMultiSearchAdapter;
...
public class PersonMultiSearchFragment extends EgovaFragment<FragmentTollgateSearchBinding, DictViewModel> {
    private TitleBackBarBinding titleBackBarBinding;

    private PersonMultiSearchAdapter adapter;
    ...
    private void initRecyclerView() {
        ...
        adapter = new PersonMultiSearchAdapter(R.layout.item_tollgate, dataList);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if(dataList.get(position).getHasSelected()==null){
                    dataList.get(position).setHasSelected(true);
                }else{
                    dataList.get(position).setHasSelected(!dataList.get(position).getHasSelected());
                }
    ...
    public void onPause() {
        super.onPause();
        EventBus.getDefault().post(dataListSrc);
    }

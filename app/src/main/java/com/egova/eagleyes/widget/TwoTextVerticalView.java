...
public class TwoTextVerticalView extends LinearLayout {
    ...
    public TwoTextVerticalView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoTextVerticalView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.item_two_vertical_text, this, true);

...
//    private static final int VALUE_TEXT_COLOR = 0xF0000000;
    private static final int VALUE_TEXT_COLOR = 0xF0e27214;

    /**
     * Items text color
     */
//    private static final int ITEMS_TEXT_COLOR = 0xFF666666;//0xFF000000
    private static final int ITEMS_TEXT_COLOR = 0xFFAAABAF;//0xFF000000
...
//            valuePaint.setTextSize(TEXT_SIZE + 5);
        ...
        if (labelPaint == null) {
            ...
            labelPaint.setTextSize(TEXT_SIZE / 2);
